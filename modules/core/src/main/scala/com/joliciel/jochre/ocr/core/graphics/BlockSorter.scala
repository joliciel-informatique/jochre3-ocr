...
/** Block sorting algorithm.
  ...
  * vertical break then: If there is horizontal overlap, we use top-down ordering: e.g. 3 comes before 4. If there is no
  * horizontal overlap, we use right-to-left ordering: e.g. 3 comes before 6, 4 comes before 7, 4 comes before 5, 4
  * comes before 6, 5 comes before 6
  */
